...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl dark:shadow-cyan-100 shadow-2xl shadow-gray-300"
      ref={containerRef}
    >
