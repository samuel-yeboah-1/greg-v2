...
export function SplineSceneBasic() {
  return (
    <Card className="w-full min-h-[600px] sm:min-h-[700px] md:h-[600px] lg:h-screen xl:h-[600px] bg-white/5 dark:bg-black/[0.96] relative overflow-hidden transition-colors duration-500">
      <Spotlight
